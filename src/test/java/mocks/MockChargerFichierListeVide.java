 ...
 * chargerFichier("toutes_invalides.csv")
 * → lève ListeQuestionsVideException car aucune question n'a pu être chargée
 */
public class MockChargerFichierListeVide implements IservicesQuestionnaire {
